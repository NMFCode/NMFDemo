...
namespace NMFDemo.Metamodels.FSM
{
    ...
    public partial class StateMachine : ModelElement, IStateMachine, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFDemo.Metamodels.FSM.StateMachine.ClassInstance)).Resolve("name")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFDemo.Metamodels.FSM.StateMachine.ClassInstance)).Resolve("states")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFDemo.Metamodels.FSM.StateMachine.ClassInstance)).Resolve("startState")));
        }
