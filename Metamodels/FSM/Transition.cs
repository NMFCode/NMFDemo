...
namespace NMFDemo.Metamodels.FSM
{
    ...
    public partial class Transition : ModelElement, ITransition, IModelElement
    {
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFDemo.Metamodels.FSM.Transition.ClassInstance)).Resolve("input")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFDemo.Metamodels.FSM.Transition.ClassInstance)).Resolve("source")));
        }
        ...
        {
            return ((ITypedElement)(((ModelElement)(NMFDemo.Metamodels.FSM.Transition.ClassInstance)).Resolve("target")));
        }
